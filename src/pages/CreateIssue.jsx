...
export default function CreateIssue() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axiosInstance.post(process.env.REACT_APP_CREATETICKET_ENDPOINT, apiData, {
        headers: {
  ...
  useEffect(() => {
    const fetchMultipleAPis = async () => {
      try {
        ...
        const [subGroupsList, orgList, priorityList, choicesList, activeUsersList] =
          await Promise.all([
            axiosInstance.get(process.env.REACT_APP_SOLUTION_GRP_API, authHeaders),
            axiosInstance.get(process.env.REACT_APP_ORGANISATION_API, authHeaders),
            axiosInstance.get(process.env.REACT_APP_PRIORITY_API, authHeaders),
            axiosInstance.get(process.env.REACT_APP_TICKET_CHOICES_API, authHeaders),
            axiosInstance.get(process.env.REACT_APP_REGISTER_API, authHeaders),
        ...
        setImpactList(choicesList.data.impact);
