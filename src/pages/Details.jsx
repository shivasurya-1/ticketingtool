...
export default function Details() {
    ...
    useEffect(() => {
        const fetchIncidents = async () => {
            ...
            try {
                ...
                const ticketResponse = await axiosInstance.get(`${process.env.REACT_APP_TICKET_DETAILS_ENDPOINT} ${ticketId}`, {
                    headers: { Authorization: `Bearer ${token}` },
                });

                setValue(ticketResponse.data); // Set full ticket data

                const slaResponse = await axiosInstance.get(` ${process.env.REACT_APP_SLA_DETAILS_ENDPOINT}${ticketId}`, {
                    headers: { Authorization: `Bearer ${token}` },
                });
    ...
    const handleSolutionSubmit = async () => {
        ...
        try {
            ...
            const response = await axiosInstance.post(process.env.REACT_APP_SOLUTION_CREATE_ENDPOINT, solutionData, {
                headers: {
            ...
            const updatedTicketResponse = await axiosInstance.get(`${process.env.REACT_APP_TICKET_DETAILS_ENDPOINT}${ticketId}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
