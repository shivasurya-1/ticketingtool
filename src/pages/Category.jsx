...
export default function Categorys() {
  const categorys = Array.from({ length: 100 }, (_, i) => ({
    number: `PR0000${i + 100}`,
    categoryName: `Company ${i + 1}`,
  ...
  const currentItems = categorys.slice(offset, offset + itemsPerPage);
  ...
  return (
    <div className="flex w-full min-h-screen">
      ...
      <main className="flex-1 mx-16">
        <div className="p-6">
          <div className="mb-6">
            <h1 className="text-[39px] font-semibold">Categorys</h1>
            <p className="text-sm text-muted-foreground">
              Add, Search, and Manage your categorys all in one place
            </p>
          </div>

          <div className="mb-6 flex items-center justify-between">
            <SearchIconRight placeholder="SearchCategory " />
          ...
          >
            <div className="relative bg-white p-8 rounded-lg shadow-lg w-[45%]">
              ...
              <form className="space-y-6 pt-4">
                ...
                <div className="flex flex-col">
                  <label htmlFor="categoryMail" className="font-medium">
                    Category Mail
                  </label>
                  <p className="text-sm text-gray-500 mt-2 mb-2">
                    Enter category mail separated by a space. For example,
                    “acme.com ajax.com”. Emails from these category mail
