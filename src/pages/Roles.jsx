...
export default function Roles() {
  ...
  const currentItems = Roles.slice(offset, offset + itemsPerPage);
      ...
      <main className="flex-1 mx-16">
        <div className="p-6">
          ...
          <div className="mb-6 flex items-center justify-between">
            <SearchIconRight placeholder="Search Roles" />
          ...
          >
            <div className="relative bg-white p-8 rounded-lg shadow-lg w-[45%]">
              <h1 className="text-lg font-semibold mb-4">Add Roles</h1>
              ...
              <form className="space-y-6 pt-4">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-sm text-gray-500 mt-2 mb-2">
                    Enter Roles mail separated by a space. For example,
                    “acme.com ajax.com”. Emails from these Roles mail
                    will be added to the Roles.
                  </p>
                  <input
                    id="organizationMail"
                    name="Roles mail"
