...
export default function AssignedToMe() {
  ...
  const fetchTickets = async () => {
    try {
      ...
      let url = `/ticket/all/?assignee=True&limit=${limit}&offset=${offset}`;
      ...
      <main className="flex-1">
        <div className="p-6 max-w-7xl mx-auto">
          <div className="flex justify-between items-center border-b border-gray-200 pb-4">
            <div>
              <h3 className="text-xl font-semibold text-gray-800">Tickets Assigned To Me</h3>
              <p className="text-gray-600 mt-2">Manage and track tickets assigned to you</p>
            </div>
