...
import { MessageCircle, X, Send, Bot, User, Mic, Volume2 } from 'lucide-react';
        ...
        <div className="fixed bottom-6 right-6 z-50">
            {!isOpen ? (
                ...
                <div className="bg-white rounded-lg shadow-xl w-80 sm:w-96 h-[500px] flex flex-col">
                    <div className="bg-gradient-to-r from-blue-900 to-blue-700 text-white p-4 rounded-t-lg flex justify-between items-center">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
                        {messages.map((message, index) => (
                            ...
                            >
                                ...
                                <div className={`max-w-[80%] p-3 rounded-lg ${message.isBot
