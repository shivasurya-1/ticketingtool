...
function Sidebar() {
  const sidebarItems = [
    ...
    // { name: "Create Inscident", route: "/request-issue/application-support/request-issue/application-support/assigned-me" },
    {
      ...
      route:
        "/request-issue/application-support/request-issue/application-support/create-issue",
    },
    {
      name: "Assigned to me",
      route:
    ...
    },
    {
      name: "Open activity",
      route:
        "/request-issue/application-support/request-issue/application-support/solution",
    },
    {
      name: "All activity",
      route:
