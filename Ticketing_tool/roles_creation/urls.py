...
urlpatterns = [
    ...
    path('role/<int:role_id>/', RoleAPIView.as_view(), name='role-update'),
    ...
    path('role-permissions/<int:role_permission_id>/', RolePermissionAPIView.as_view(), name='role-permissions'),
    path('user_role/',UserRoleAPIView.as_view(),name = 'user_role'),
    path('user_role/<int:user_role_id>/',UserRoleAPIView.as_view(),name = 'user_role_detail')
]
