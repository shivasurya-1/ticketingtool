...
urlpatterns = [
    path('details/', ProjectDetailsAPI.as_view(), name='details'), # to get assigned projects list
    ...
    path('projectdetails/', ProjectDashDetailsAPI.as_view(), name='projectdetails'), #for get projects.
